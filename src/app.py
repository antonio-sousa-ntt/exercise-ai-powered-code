...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and competitive matches on the field",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Learn basketball basics and scrimmage with teammates",
    ...
    "Science Bowl": {
        "description": "Study science topics and compete in quiz bowl rounds",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
